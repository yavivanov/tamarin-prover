...
generateRule freevars premises idx =  OpenProtoRule (Rule (ProtoRuleEInfo (StandRule $ DefdRuleName (show idx)) ([]) ([])) (freesToFresh . deleteGlobals $ freevars) (premisesToOut premises ) ([generateAction (deleteGlobals freevars) idx]) ([])) []

generateDiffRule :: Side -> [LVar] -> [LNFact] -> Int -> OpenProtoRule
generateDiffRule side freevars premises idx =  OpenProtoRule (Rule (ProtoRuleEInfo (StandRule $ DefdRuleName (show side ++ show idx)) ([]) ([])) (freesToFresh . deleteGlobals $ freevars) (premisesToOut premises ) ([generateAction (deleteGlobals freevars) idx]) ([])) []
