...
removeTranslationItems thy =
  Theory {_thyName=(L.get thyName thy)
    ...
    where
      ...
      removeTranslationElement (ConfigurationBlockItem b) = ConfigurationBlockItem b
...
openTranslatedTheory thy =
  Theory {_thyName=(L.get thyName thy)
    ...
    where
      ...
      addTranslationElement (ConfigurationBlockItem b) = Just $ ConfigurationBlockItem b
  ...
  where
    ...
    diffPart = mapMaybe f items
      where
        ...
        f (DiffConfigurationBlockItem b) = Just (DiffConfigurationBlockItem b)
        f _                              = Nothing
    ...
    toSide _ (ConfigurationBlockItem b) = Just $ DiffConfigurationBlockItem b
